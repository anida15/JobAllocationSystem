...
<?php include 'navigation.php';?>
                    ...
                    <div class="tab-pane active" id="user-timeline">
                        <div class="timeline-post">
                            ...
                            <div class="post-content">
                                <p>In the bustling realm of industry, <?php echo $username ; ?> embodies the essence of
                                    dedication and skill.
                                    With grease-stained hands and a steadfast resolve, he navigates the intricate
                                    machinery of the factory floor.</p>
                                <p> <?php echo $username ; ?>'s expertise transcends mere mechanics; it's a symphony of
                                    intuition and
                                    experience. With a keen eye for detail, he troubleshoots with finesse, diagnosing
                                    issues before they escalate.</p>
                                <p> His commitment to safety is unwavering. Clad in protective gear, he moves with
                                    purpose, ensuring every task adheres to stringent protocols. Each day, he returns
                                    home with a sense of fulfillment, knowing his diligence keeps the wheels of industry
                                    turning.</p>
                            </div>
  ...
  function submitForm(){
    ...
    xhr.open('POST','process/updateUser.php' , true);
    xhr.onload = function(){
