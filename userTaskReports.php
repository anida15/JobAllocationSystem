...
$sql_completed_tasks = "SELECT task_allocated_id, task_title,task_completion_status , price FROM task_allocated WHERE   user_id =$user_id";
...
<?php include 'navigation.php';?>
    ...
    <main class="app-content">
        <div class="app-title">
            <div>
                <h1><i class="bi bi-receipt"></i>User Report</h1>
            </div>
