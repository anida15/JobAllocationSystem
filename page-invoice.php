...
$sql_completed_tasks = "SELECT task_allocated_id, task_title , price FROM task_allocated WHERE task_completion_status = 'YES' AND user_id =$user_id";
            ...
            <div class="col-md-12">
                <div class="tile">
                    <section class="invoice">
                        <div class="row mb-4">
                            <div class="col-6">
                                <h2 class="page-header"><i class="bi bi-globe"></i>Job Allo.</h2>
                            </div> 
                        </div>
                                ...
                                <table class="table table-striped">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $task['task_allocated_id']; ?></td>
                                            <td>$<?php echo $fixed_rate_per_task; ?></td>
